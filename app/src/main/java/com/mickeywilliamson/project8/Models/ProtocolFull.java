...
public class ProtocolFull extends Protocol {
    ...
    public ArrayList<Hour> buildProtocol() {
        ...
        HOUR_6 = new Hour(6, new CeCoe(CeCoe.CE));
        schedule.add(HOUR_6);
        ...
        supplements.clear();
        supplements.add(new Supplement(Supplement.SUPPLEMENT_POTASSIUM));
        HOUR_9 = new Hour(9, new Juice(Juice.JUICE_GREEN), (ArrayList<Supplement>) supplements.clone());
        schedule.add(HOUR_9);
        ...
        supplements.add(new Supplement(Supplement.SUPPLEMENT_THYROID));
        supplements.add(new Supplement(Supplement.SUPPLEMENT_NIACIN));
        HOUR_10 = new Hour(10, new Juice(Juice.JUICE_CARROT_APPLE), (ArrayList<Supplement>) supplements.clone(), new CeCoe(CeCoe.CE));
        ...
        supplements.clear();
        supplements.add(new Supplement(Supplement.SUPPLEMENT_LIVER));
        HOUR_15 = new Hour(15, new Juice(Juice.JUICE_CARROT), (ArrayList<Supplement>) supplements.clone(), new CeCoe(CeCoe.CE));
        schedule.add(HOUR_15);

        supplements.clear();
        supplements.add(new Supplement(Supplement.SUPPLEMENT_LIVER));
        HOUR_16 = new Hour(16, new Juice(Juice.JUICE_CARROT), (ArrayList<Supplement>) supplements.clone(), new CeCoe(CeCoe.CE));
        ...
        supplements.clear();
        HOUR_22 = new Hour(22, new CeCoe(CeCoe.CE));
